 ...
 * @description Object containing Zod schemas for body, query, and params
 */
interface RequestSchemas {
  body?: z.ZodTypeAny;
  query?: z.ZodTypeAny;
...
/**
 * Validates the request body, query, and params using Zod schemas.
 * If any of the validations fail, an HTTP 400 status code will be returned.
 * @param {RequestSchemas} schemas - Object containing Zod schemas for body, query, and params
